        ...
        <div class="login-form">
            <form method="POST" action="<?php echo e(route('login')); ?>">
                ...
                <div class="sign-in-htm">
                    ...
                    <div class="group">
                        <input id="check" name="remember" type="checkbox" class="check" <?php echo e(old('remember') ? 'checked' : ''); ?>>
...
<?php /**PATH C:\xampp\htdocs\sb\appointment\resources\views/login_reg.blade.php ENDPATH**/ ?>
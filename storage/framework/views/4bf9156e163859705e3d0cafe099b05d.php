...
<nav class="navbar navbar-expand-lg bg-body-tertiary" style="    position: sticky;top: 0px;z-index: 33;    padding: 0px;        ">
    <div class="container-fluid" style="    padding: 0px;">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" style="justify-content: space-around;;background-color:white;">
            <div class="icon">
                <i class="fa-solid fa-box-open" style="font-size: 400%;    color: #3061bc;"></i>
            </div>
                ...
                <div class="card-container">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <img src="<?php echo e($item->product_img ? asset($item->product_img) : asset('storage/images/default_profile.png')); ?>" alt="Profile Picture" class="card-img">
                            <div class="card-actions">
                                <a href="<?php echo e(url('/stock/' . $item->id)); ?>" title="View Student"><i class="fa-solid fa-circle-info"></i></a>

                                <a href="<?php echo e(url('/stock/' . $item->id . '/edit')); ?>" title="Edit Student"><i class="fa-regular fa-pen-to-square"></i></a>
                        ...
                        <div class="card-body">
                            <h5 class="card-title"><i class="fa-solid fa-box-open"></i> <?php echo e($item->product_name); ?></h5>
                            <h5 class="card-title"><i class="fa-regular fa-square-plus"></i> <?php echo e($item->qty); ?></h5>
                            <h5 class="card-title"><i class="fa-solid fa-rotate"></i> <?php echo e($item->exp_date); ?></h5>
...
<?php echo $__env->make('hospitals.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sb\appointment\resources\views/stock/index.blade.php ENDPATH**/ ?>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary"
        ...
        <div class="container-fluid" style="    padding: 0px;">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent"
                ...
                <div class="icon">
                    <i class="fa-regular fa-user" style="font-size: 400%;    color: #3061bc;"></i>
                </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="card-actions">
                                        <a href="<?php echo e(url('/profile/' . $item->id)); ?>" title="View Student"><i
                                                class="fa-solid fa-circle-info"></i></a>

                                        <a href="<?php echo e(url('/profile/' . $item->id . '/edit')); ?>" title="Edit Student"><i
                                                class="fa-regular fa-pen-to-square"></i></a>

                                        <?php if(session('user_type') == 1): ?>
                                            <form id="delete-form-<?php echo e($item->id); ?>" method="POST"
                                                action="<?php echo e(route('profile.destroy', $item->id)); ?>" accept-charset="UTF-8"
                                                style="display:inline">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('DELETE'); ?>
                                                <i class="fa-solid fa-trash-can trash_it" style="cursor:pointer"
                                                    data-form-id="delete-form-<?php echo e($item->id); ?>"></i>
                                            </form>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <h5 class="card-title"><i class="fa-solid fa-user-doctor"></i>
                                        <?php echo e($item->first_name . ' ' . $item->last_name); ?></h5>
...
<?php echo $__env->make('hospitals.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sb\appointment\resources\views/profile/index.blade.php ENDPATH**/ ?>
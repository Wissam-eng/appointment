<?php $__env->startSection('content'); ?>
    ...
    width: 69%;">
        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(url('stock')); ?>"  method="post" enctype="multipart/form-data">
                ...
                <img id="clickableImage" style="width: 15%; margin: 1% auto; cursor: pointer;"
                    src="<?php echo e(asset('storage/images/default_profile.png')); ?>" name="first_name" value=""
                ...
                <div class="frm">
                    ...
                    <input type="hidden" name="facility_id" id="facility_id" value="<?php echo e(session('facility_id')); ?>" class="form-control">
...
<?php echo $__env->make('hospitals.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sb\appointment\resources\views/stock/create.blade.php ENDPATH**/ ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="card" style="    margin: 20px auto; width: 69%;">
        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(url('categories')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>



                <input type="file" name="img" value="default_profile.png" id="img" style="display: none;">
                <img id="clickableImage" style="width: 15%; margin: 1% auto; cursor: pointer;" src="<?php echo e(asset('storage/images/default_profile.png')); ?>" name="first_name" value="" class="form-control" disabled>
                ...
                <div class="frm">
                    ...
                    <input type="hidden" name="facility_id" value="<?php echo e(auth()->user()->facility_id); ?>">
...
<?php echo $__env->make('hospitals.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sb\appointment\resources\views/categories/create.blade.php ENDPATH**/ ?>
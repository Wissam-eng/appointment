    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary"
        ...
        <div class="container-fluid" style="    padding: 0px;">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent"
                ...
                <div class="icon">
                    <i class="fa-regular fa-star" style="font-size: 400%;    color: #3061bc;"></i>
                </div>
                        ...
                        <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-actions">
                                        ...
                                        <form id="delete-form-<?php echo e($item->id); ?>" method="POST"
                                            action="<?php echo e(route('review.destroy', $item->id)); ?>" accept-charset="UTF-8"
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title"><i class="fa-regular fa-user"></i> <?php echo e($item->client->name); ?></h5>
                                    <h5 class="card-title" style="word-wrap: break-word; white-space: normal;">
                                        <i class="fa-regular fa-comment-dots"></i> <?php echo e($item->comment); ?>
...
<?php echo $__env->make('hospitals.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sb\appointment\resources\views/review/index.blade.php ENDPATH**/ ?>
        ...
        <div class="container" style="margin-top: 2%;">
            <div class="card-body">
                ...
                <div class="card-container">
                    @foreach ($operations_deleted as $item)
                        <div class="card">
                            <div class="card-header">
                                <div class="card-actions">
                                    <form id="restore-form-{{ $item->id }}" method="POST"
                                        action="{{ route('operations.restore', $item->id) }}" accept-charset="UTF-8"
                                    ...
                                    <form id="delete-form-{{ $item->id }}" method="POST"
                                        action="{{ route('operations.delete', $item->id) }}" accept-charset="UTF-8"
                                        style="display:inline">
                                        {{ Method_field('DELETE') }}
                                        {{ csrf_field() }}
                                ...
                                <img src="{{ $item->operations_pic ? asset($item->operations_pic) : asset('storage/images/default_profile.png') }}"
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"><i class="fa-solid fa-stethoscope"></i>
                                    {{ $item->specialization ? $item->specialization_name : 'No hospital assigned' }}</p>
                                <p class="card-text"><i class="fa-solid fa-circle-h"></i>
                                    {{ $item->hospital ? $item->hospital->hospital_name : 'No hospital assigned' }}</p>

                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="card-actions">
                                        <a href="{{ url('/facilities/' . $item->id) }}" title="View Student"><i
                                        ...
                                        @if (session('user_type') == 1)
                                            ...
                                            <form id="delete-form-{{ $item->id }}" method="POST"
                                                action="{{ route('clinics.destroy', $item->id) }}" accept-charset="UTF-8"
                                ...
                                <div class="card-body">
                                    ...
                                    @if ($facility_type == 3)
                                        <p class="card-text"><i class="fa-solid fa-cent-sign"></i> {{ $item->name }}</p>
                                    @elseif ($facility_type == 1)
                                        <p class="card-text"><i class="fa-solid fa-h"></i> {{ $item->name }}</p>
                                    @elseif ($facility_type == 2)
                                        <p class="card-text"><i class="fa-solid fa-c"></i> {{ $item->name }}</p>
                                    @endif
                                    ...
                                    <p class="card-title" style="overflow: auto"><i

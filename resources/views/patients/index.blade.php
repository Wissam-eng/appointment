                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="card-actions">
                                        <a href="{{ url('/profile/' . $item->id) }}" title="View Student"><i
                                                class="fa-solid fa-circle-info"></i></a>

                                        <a href="{{ url('/profile/' . $item->id . '/edit') }}" title="Edit Student"><i
                                                class="fa-regular fa-pen-to-square"></i></a>

                                        @if (session('user_type') == 1)
                                            <form id="delete-form-{{ $item->id }}" method="POST"
                                                action="{{ route('profile.destroy', $item->id) }}" accept-charset="UTF-8"
                                ...
                                <div class="card-body">
                                    <h5 class="card-title"><i class="fa-solid fa-user-injured"></i>
                                        {{ $item->profile->first_name . ' ' . $item->profile->last_name }}</h5>
                                    <p class="card-text"><i class="fa-solid fa-phone"></i> {{ $item->profile->mobile }}</p>
                                </div>
                            </div>
                        @endforeach
                    </div>

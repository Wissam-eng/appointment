...
@section('content')
    ...
    {{-- <h1>{{ session('user_id') }} user_id</h1>
    <h1>{{ session('facility_id') }} facility_id</h1>
    <h1>{{ session('user_type') }} user_type</h1>
    <h1>{{ session('facility_type') }} facility_type</h1> --}}
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-container">
                            ...
                            <div class="card">
                                ...
                                <div class="dd">
                                    <h5 class="card-title"><i class="fa-solid fa-hashtag"></i>{{ $counts['hospital'] }}
                                    </h5>
                            ...
                            <div class="card">
                                ...
                                <div class="dd">
                                    <h5 class="card-title"><i class="fa-solid fa-hashtag"></i>{{ $counts['centers'] }} </h5>
                            ...
                            <div class="card">
                                <div class="card-header" style="text-align: center;">
                                    <a href="{{ route('facilities.clinics') }}">
                                ...
                                <div class="dd">
                                    <h5 class="card-title"><i class="fa-solid fa-hashtag"></i>{{ $counts['clinics'] }} </h5>
                            ...
                            <div class="card">
                                <div class="card-header" style="text-align: center;">
                                    <a href="{{ url('/facilities/pharmacies') }}">
                                ...
                                <div class="dd">
                                    <h5 class="card-title"><i class="fa-solid fa-hashtag"></i>{{ $counts['pharmacy'] }}
                                    </h5>
                            ...
                            {{-- <div class="card">
                                ...
                                <div class="dd">
                                    <h5 class="card-title"><i class="fa-solid fa-hashtag"></i>416 </h5>
                                    <a title="View Student"><i class="fa-solid fa-circle-info"
                                            style="cursor: pointer;"></i></a>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="dd">
                                    <h5 class="card-title"><i class="fa-solid fa-hashtag">637</i> </h5>
                                    <a title="View Student"><i class="fa-solid fa-circle-info"
                                            style="cursor: pointer;"></i></a>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="dd">
                                    <h5 class="card-title"><i class="fa-solid fa-hashtag"></i>313 </h5>
                                    <a title="View Student"><i class="fa-solid fa-circle-info"
                                            style="cursor: pointer;"></i></a>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="dd">
                                    <h5 class="card-title"><i class="fa-solid fa-hashtag"></i>858 </h5>
                                    <a title="View Student"><i class="fa-solid fa-circle-info"
                                            style="cursor: pointer;"></i></a>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="dd">
                                    <h5 class="card-title"><i class="fa-solid fa-hashtag"></i>565 </h5>
                                    <a title="View Student"><i class="fa-solid fa-circle-info"
                                            style="cursor: pointer;"></i></a>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-header" style="text-align: center;">
                                    ...
                                    <i class="fa-solid fa-briefcase"
                                        style="font-size: 300%;color: #495057; cursor: pointer;"></i>
                                ...
                                <div class="dd">
                                    <h5 class="card-title"><i class="fa-solid fa-hashtag"></i>665 </h5>
                                    <a title="View Student"><i class="fa-solid fa-circle-info"
                                            style="cursor: pointer;"></i></a>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-header" style="text-align: center;">
                                    ...
                                    <i class="fa-solid fa-chart-line"
                                        style="font-size: 300%;color: #a38c48; cursor: pointer;"></i>
                                ...
                                <div class="dd">
                                    <h5 class="card-title"><i class="fa-solid fa-hashtag"></i> 984</h5>
                                    <a title="View Student"><i class="fa-solid fa-circle-info"
                                            style="cursor: pointer;"></i></a>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-header" style="text-align: center;">
                                    ...
                                    <i class="fa-solid fa-layer-group"
                                        style="font-size: 300%;color: #f27474; cursor: pointer;"></i>
                                ...
                                <div class="dd">
                                    <h5 class="card-title"><i class="fa-solid fa-hashtag"></i>752 </h5>
                                    <a title="View Student"><i class="fa-solid fa-circle-info"
                                            style="cursor: pointer;"></i></a>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-header" style="text-align: center;">
                                    ...
                                    <i class="fa-solid fa-gear"
                                        style="font-size: 300%;color: #6c757d; cursor: pointer;"></i>
                                ...
                                <div class="dd">
                                    <h5 class="card-title"><i class="fa-solid fa-hashtag"></i>256 </h5>
                                    <a title="View Student"><i class="fa-solid fa-circle-info"
                                            style="cursor: pointer;"></i></a>
                                </div>
                            </div> --}}
                        ...
                        <div class="card-container">
                            ...
                            @if (session('facility_type') == 1 ||
                                ...
                                <div class="card">
                                    ...
                                    <div class="dd">
                                        <h5 class="card-title"><i class="fa-solid fa-hashtag"></i>{{ $counts['doctors'] }}
                                        </h5>
                                ...
                                <div class="card">
                                    ...
                                    <div class="dd">
                                        <h5 class="card-title"><i
                                                class="fa-solid fa-hashtag"></i>{{ $counts['appointments'] }}
                                        </h5>
                                ...
                                <div class="card">
                                    ...
                                    <div class="dd">
                                        <h5 class="card-title"><i class="fa-solid fa-hashtag">{{ $counts['rooms'] }}</i>
                                        </h5>
                            ...
                            <div class="card">
                                ...
                                <div class="dd">
                                    <h5 class="card-title"><i class="fa-solid fa-hashtag"></i>{{ $counts['employees'] }}
                                    </h5>
                            ...
                            <div class="card">
                                ...
                                <div class="dd">
                                    <h5 class="card-title"><i class="fa-solid fa-hashtag"></i>{{ $counts['stock'] }}
                                    </h5>
            ...
            <div id="carouselExampleSlidesOnly1" class="carousel slide c" data-bs-ride="carousel"
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="{{ asset('storage/images/kk.webp') }}" class="d-block w-100" alt="Slide 1">
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset('storage/images/x.webp') }}" class="d-block w-100" alt="Slide 2">
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset('storage/images/a.webp') }}" class="d-block w-100" alt="Slide 3">
                    </div>
                </div>
            </div>
        </div>

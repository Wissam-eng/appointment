        ...
        <div class="container-fluid" style="    padding: 0px;">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent"
                ...
                <div class="icon">
                    ...
                    <i class="fa-solid fa-crown" style="font-size: 400%;    color: #3061bc;"></i>
                </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="card-actions">
                                        <a href="{{ url('/roomsClass/' . $item->id . '/edit') }}" title="Edit Student">
                                            <i class="fa-regular fa-pen-to-square"></i>
                                        </a>

                                        <form id="delete-form-{{ $item->id }}" method="POST"
                                            action="{{ route('roomsClass.destroy', $item->id) }}" accept-charset="UTF-8"
                                ...
                                <div class="card-body">
                                    <h5 class="card-title"><i class="fa-solid fa-crown"></i> {{ $item->roomsClass_name }}
                                    </h5>
                                    <p class="card-text"><i
                                            class="fa-solid fa-money-check-dollar"></i>{{ $item->price_day }}</p>
                               
                                    <p class="card-text"><i class="fa-solid fa-bed"></i> {{ $item->number_beds }}</p>
                                    <p class="card-text"><i class="fa-solid fa-people-group"></i>{{ $item->number_companions }}</p>
                                    ...
                                    @else
                                        ...
                                        <p class="card-text no-internet"><i class="fa-solid fa-wifi"></i> </p>

                ...
                <div class="card-container">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <img src="{{ $item->img ? asset($item->img) : asset('storage/images/default_profile.png') }}" alt="Profile Picture" class="card-img">
                            <div class="card-actions">

                                <a href="{{ url('/categories/' . $item->id . '/edit') }}" title="Edit Student"><i class="fa-regular fa-pen-to-square"></i></a>
                        ...
                        <div class="card-body">
                            <h5 class="card-title"><i class="fa-solid fa-puzzle-piece"></i> {{ $item->category_name  }}</h5>

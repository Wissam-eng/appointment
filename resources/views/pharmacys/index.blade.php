                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="card-actions">
                                        ...
                                        {{-- <a href="{{ url('/clinics/' . $item->id . '/edit') }}" title="Edit Student"><i
                                                class="fa-regular fa-pen-to-square"></i></a>

                                        <form id="delete-form-{{ $item->id }}" method="POST" action="{{ route('clinics.destroy', $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                            @csrf
                                            @method('DELETE')
                                ...
                                <div class="card-body">
                                    <p class="card-text"><i class="fa-solid fa-staff-snake"></i> {{ $item->name}}</p>

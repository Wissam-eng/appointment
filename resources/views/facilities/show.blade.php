...
<div class="d-flex" style="    flex-direction: column;justify-content: space-around;height: 100%;">
    ...
    <div class="card-container" style="flex-direction: column;">
        ...
        <div class="card-wrapper">
            @foreach($facility->rooms as $item2)
            <div class="card">
                <div class="card-header">
                    <div class="card-actions">
                        <a href="{{ url('/rooms/' . $item2->id) }}" title="View Student"><i class="fa-solid fa-circle-info"></i></a>
                        <a href="{{ url('/rooms/' . $item2->id . '/edit') }}" title="Edit Student"><i class="fa-regular fa-pen-to-square"></i></a>
                        <form id="delete-form-{{ $item2->id }}" method="POST" action="{{ route('rooms.destroy', $item2->id) }}" accept-charset="UTF-8" style="display:inline">
                            @csrf
                            @method('DELETE')
                            <i class="fa-solid fa-trash-can trash_it" style="cursor:pointer" data-form-id="delete-form-{{ $item2->id }}"></i>
                        </form>
    ...
    <div class="card-container" style="flex-direction: column;">
        <div class="icon">
            <i class="fa-solid fa-user-tie" style="font-size: 400%;    color: #3061bc;"></i>
        </div>
        <div class="card-wrapper">
            @foreach($facility->employees as $item2)
            <div class="card">
                <div class="card-header">
                    <div class="card-actions">
                        <a href="{{ url('/doctors/' . $item2->id) }}" title="View Student"><i class="fa-solid fa-circle-info"></i></a>
                        <a href="{{ url('/facilities/' . $item2->id . '/edit') }}" title="Edit Student"><i class="fa-regular fa-pen-to-square"></i></a>
                        <form id="delete-form-{{ $item2->id }}" method="POST" action="{{ route('facilities.destroy', $item2->id) }}" accept-charset="UTF-8" style="display:inline">
                            @csrf
                            @method('DELETE')
                            <i class="fa-solid fa-trash-can trash_it" style="cursor:pointer" data-form-id="delete-form-{{ $item2->id }}"></i>
                        </form>
    ...
    <div class="card-container" style="flex-direction: column;">
        ...
        <div class="card-wrapper">
            @foreach($facility->appointments as $item2)
            <div class="card">
                <div class="card-header">
                    <div class="card-actions">
                        <a href="{{ url('/doctors/' . $item2->id) }}" title="View Student"><i class="fa-solid fa-circle-info"></i></a>
    ...
    <div class="card-container" style="flex-direction: column;">
        ...
        <div class="card-wrapper">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-actions">
                        <a href="{{ url('/appointments/' . $item2->id) }}" title="View Student"><i class="fa-solid fa-circle-info"></i></a>
                        <a href="{{ url('/appointments/' . $item2->id . '/edit') }}" title="Edit Student"><i class="fa-regular fa-pen-to-square"></i></a>
                        <form id="delete-form-{{ $item2->id }}" method="POST" action="{{ route('facilities.destroy', $item2->id) }}" accept-charset="UTF-8" style="display:inline">
                            @csrf
                            @method('DELETE')
                            <i class="fa-solid fa-trash-can trash_it" style="cursor:pointer" data-form-id="delete-form-{{ $item2->id }}"></i>

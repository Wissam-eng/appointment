                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-actions">
                                <a href="{{ url('/facilities/' . $item->id) }}" title="View Student"><i class="fa-solid fa-circle-info"></i></a>

                                <a href="{{ url('/facilities/' . $item->id . '/edit') }}" title="Edit Student"><i class="fa-regular fa-pen-to-square"></i></a>

                                <form id="delete-form-{{ $item->id }}" method="POST" action="{{ route('facilities.destroy', $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                    @csrf
                                    @method('DELETE')
                        ...
                        <div class="card-body" style="overflow: auto">
                            ...
                            <p class="card-title"><i class="fa-solid fa-location-dot"></i>{{ $item->address }} </p>
                            <p class="card-title"><i class="fa-solid fa-user"></i>{{ $item->user ? $item->user->name : '' }} </p>
                        </div>
                    </div>
                    @endforeach
                </div>

    ...
    <div class="container-fluid" style="    padding: 0px;">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" style="justify-content: space-between;background-color:white;">
            <div class="icon">
                ...
                <i class="fa-solid fa-s" style="font-size: 400%;    color: #3061bc;"></i>
            </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-actions">
                                ...
                                <a href="{{ url('/specializations/' . $item->id . '/edit') }}" title="Edit Student"><i class="fa-regular fa-pen-to-square"></i></a>

                                <form id="delete-form-{{ $item->id }}" method="POST" action="{{ route('specializations.destroy', $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                    @csrf
                                    @method('DELETE')
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"><i class="fa-solid fa-s"></i> {{ $item->specialization_name }}</p>
                        </div>
                    </div>
                    @endforeach
                </div>

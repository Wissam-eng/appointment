...
@section('content')
    ...
    width: 69%;">
        ...
        <div class="card-body">
            ...
            <form action="{{ url('clientAdvertisements') }}" method="post" enctype="multipart/form-data">
                {!! csrf_field() !!}
                ...
                <div class="form-row">
                    ...
                    <input type="text" name="start_date" id="start_date" class="form-control currentDate">
                </div>

                <div class="form-row">
                    <label for="end_date">end_date</label><br>
                    <input type="text" name="end_date" id="end_date" class="form-control dateAfterOneMonth">
                </div>

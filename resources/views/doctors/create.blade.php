...
@section('content')
    ...
    width: 69%;">
        ...
        <div class="card-body">
            ...
            <form action="{{ url('doctors') }}" class="frm" method="post" enctype="multipart/form-data">
                ...
                <div class="frm">
                    ...
                    <input type="hidden" name="Establishment_id" id="facility_id" value="{{ session('facility_id') }}">

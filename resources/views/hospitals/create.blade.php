...
@section('content')
    ...
    width: 69%;">
        ...
        <div class="card-body">
            ...
            <form action="{{ url('hospitals') }}" method="post">
                {!! csrf_field() !!}
              ...
              <div class="form-row">
                <label>Name</label></br>
                <input type="text" name="hospital_name" id="name" class="form-control"></br>
              </div>


              <div class="form-row">
                <label>Address</label></br>
                <input type="text" name="hospital_address" id="address" class="form-control">
              </div>

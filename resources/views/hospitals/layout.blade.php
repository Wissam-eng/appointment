        ...
        <div class="sidebar bg-gradient-primary  p-3 text-white"
            ...
            <ul class="nav flex-column">
                ...
                @if (session('user_type') == 1)
                    ...
                    <li class="actions">
                        <a href="{{ url('/profile/create') }}" title="Add New Student" id="Addprofile" class="down">
                            <i class="fa-solid fa-plus"></i></a>

                        <a href="{{ url('/profile') }}" class=" text-white down" id="Trashprofile">
                            <i class="fa-solid fa-user-doctor"></i>
                        </a>

                        <a href="{{ url('/profile/trash') }}" class="down" id="Deleteprofile" title="Add New Student">
                    ...
                    <li class="actions">
                        <a href="{{ url('/facilities/create') }}" title="Add New Hospital" id="Addfacility"
                            class="down">
                            <i class="fa-regular fa-square-plus"></i>
                        </a>
                        <a href="{{ url('/facilities/') }}" class="text-white down" id="Deletefacility">
                            <i class="fa-regular fa-building"></i>
                        </a>
                        <a href="{{ url('facilities.trash') }}" class="down" id="Trashfacility"
                    ...
                    <li class="actions">
                        <a href="{{ url('/clientAdvertisements/create') }}" title="Add New Student"
                            id="AddclientAdvertisements" class="down">
                            <i class="fa-solid fa-plus"></i></a>

                        <a href="{{ url('/clientAdvertisements') }}" class=" text-white down"
                            id="TrashclientAdvertisements">
                            <i class="fa-brands fa-buysellads"></i>
                        </a>

                        <a href="{{ url('/clientAdvertisements/trash') }}" class="down"
                ...
                @elseif (session('user_type') == 2)
                    <li class="nav-item dropdown">
                        <a href="{{ url('/profile.myprofile/' . Auth::user()->id) }}"
                    ...
                    @if (session('facility_type') == 1)
                        <!-- Hospital Section -->
                        <li class="nav-item dropdown">
                            <a href="{{ url('/facilities.hospitals') }}" class="nav-link text-white dropdown-toggle"
                        ...
                        {{-- <li class="actions">
                            ...
                            <a href="{{ url('/hospitals/trash') }}" class="down" id="TrashHospital"
                                title="Trash Hospitals">
                                <i class="fa-solid fa-trash"></i>
                            </a>
                        </li> --}}
                        ...
                        <li class="actions">
                            <a href="{{ url('/analysis/create') }}" title="Add New specialization" id="Addanalysis"
                                class="down">
                                <i class="fa-solid fa-plus"></i>
                            </a>

                            <a href="{{ url('/analysis') }}" class="text-white down" id="Trashanalysis">

                                <i class="fa-solid fa-dna"></i>
                            </a>

                            <a href="{{ url('/analysis/trash') }}" class="down" id="Deleteanalysis"
                                title="Trash Rooms">
                                <i class="fa-solid fa-trash"></i>
                            </a>
                        </li>
                        ...
                        <li class="actions">
                            <a href="{{ url('/operations/create') }}" title="Add New specialization"
                                id="Addoperations" class="down">
                                <i class="fa-solid fa-plus"></i>
                            </a>

                            <a href="{{ url('/operations') }}" class="text-white down" id="Trashoperations">

                                <i class="fa-solid fa-heart-pulse"></i>
                            </a>

                            <a href="{{ url('/operations/trash') }}" class="down" id="Deleteoperations"
                                title="Trash Rooms">
                                <i class="fa-solid fa-trash"></i>
                            </a>
                        </li>
                    @elseif (session('facility_type') == 2 || session('facility_type') == 3)
                        <!-- Clinic Section -->
                        <li class="nav-item dropdown">
                            <a href="{{ url('/facilities.clinics') }}" class="nav-link text-white dropdown-toggle"
                                id="clinicDropdown" role="button" data-toggle="dropdown" aria-expanded="false">
                                <i class="fa-solid fa-c"></i>
                            </a>
                        </li>
                    @elseif (session('facility_type') == 4)
                        <!-- Pharmacy Section -->
                        <li class="nav-item dropdown">
                            <a href="{{ url('/pharmacys') }}" class="nav-link text-white dropdown-toggle"
                        ...
                        {{-- <li class="actions">
                            ...
                            <a href="{{ url('/categories/create') }}" title="Add New Pharmacy" id="Addpharamacy"
                                class="down">
                                <i class="fa-solid fa-puzzle-piece"></i>
                            </a>

                            <a href="{{ url('/pharmacys') }}" class="text-white down" id="Trashpharamacy">
                                <i class="fa-solid fa-staff-snake"></i>
                            </a>

                            <a href="{{ url('/pharmacys/trash') }}" class="down" id="Deletepharamacy"
                                title="Trash Pharmacy">
                                <i class="fa-solid fa-trash"></i>
                            </a>

                        </li> --}}
                    @elseif (session('facility_type') == 5)
                        <li class="nav-item dropdown">
                            <a href="{{ url('/facilities.company') }}" class="nav-link text-white dropdown-toggle"
                                id="pharmacyDropdown" role="button" data-toggle="dropdown" aria-expanded="false">
                        ...
                        <li class="actions">
                            <a href="{{ url('/categories/create') }}" title="Add New specialization"
                                id="Addcategories" class="down">
                                <i class="fa-solid fa-plus"></i></a>
                            <a href="{{ url('/categories') }}" class="text-white down" id="Trashcategories">

                                <i class="fa-solid fa-puzzle-piece"></i>
                            </a>
                            <a href="{{ url('/categories/trash') }}" class="down" id="Deletecategories"
                                title="Trash Rooms">
                                <i class="fa-solid fa-trash"></i>
                            </a>
                        </li>
                        ...
                        <li class="actions">
                            <a href="{{ url('/stock/create') }}" title="Add New Product" id="Addproducts"
                                class="down">
                                <i class="fa-solid fa-plus"></i></a>
                            <a href="{{ url('/stock') }}" class="text-white down" id="Trashproducts">
                                <i class="fa-solid fa-box-open"></i>
                            </a>
                            <a href="{{ url('/stock/trash') }}" class="down" id="Deleteproducts"
                        ...
                        <li class="actions">
                            {{-- <a href="{{ url('/cart/create') }}" title="Add New Order" id="Addorders" class="down">
                            <i class="fa-solid fa-plus"></i></a> --}}
                            <a href="{{ url('/cart') }}" class="text-white down" id="Trashorders">
                                <i class="fa-solid fa-cart-shopping"></i>
                            </a>
                            <a href="{{ url('/cart/trash') }}" class="down" id="Deleteorders"
                                title="Trash Orders">
                                <i class="fa-solid fa-trash"></i>
                            </a>
                        </li>
                        ...
                        <li class="actions">
                            <a href="{{ url('/employees/create') }}" title="Add New Employee" id="Addemployees"
                                class="down">
                                <i class="fa-solid fa-plus"></i></a>
                            <a href="{{ url('/employees') }}" class="text-white down" id="Trashemployees">
                                <i class="fa-solid fa-briefcase"></i>
                            </a>
                            <a href="{{ url('/employees/trash') }}" class="down" id="Deleteemployees"
                        ...
                        <li class="actions">
                            <a href="{{ url('/FQA/create') }}" title="Add New Student" id="AddFQA"
                                class="down">
                                <i class="fa-solid fa-plus"></i></a>

                            <a href="{{ url('/FQA') }}" class=" text-white down" id="TrashFQA">
                                <i class="fa-solid fa-question"></i>
                            </a>

                            <a href="{{ url('/FQA/trash') }}" class="down" id="DeleteFQA"
                        ...
                        <!----- review Section -->
                        <li class="nav-item dropdown">
                            <a href="{{ url('/review') }}" class="nav-link text-white dropdown-toggle"
                    ...
                    @if (session('facility_type') == 1 ||
                        ...
                        <li class="actions">
                            <a href="{{ url('/specializations/create') }}" title="Add New specialization"
                                id="Addspecialization" class="down">
                                <i class="fa-solid fa-plus"></i></a>
                            <a href="{{ url('/specializations') }}" class="text-white down"
                                id="Trashspecialization">

                                <i class="fa-solid fa-s"></i>
                            </a>
                            <a href="{{ url('/specializations/trash') }}" class="down" id="Deletespecialization"
                                title="Trash Rooms">
                                <i class="fa-solid fa-trash"></i>
                            </a>
                        </li>
                        ...
                        <li class="actions">
                            <a href="{{ url('/doctors/create') }}" title="Add New Doctor" id="AddDoctor"
                                class="down">
                                <i class="fa-regular fa-square-plus"></i></a>
                            <a href="{{ url('/doctors') }}" class="text-white down" id="TrashDoctor">
                                <i class="fa-solid fa-user-doctor"></i>
                            </a>
                            <a href="{{ url('/doctors/trash') }}" class="down" id="DeleteDoctor"
                                title="Trash Doctors">
                                <i class="fa-solid fa-trash"></i>
                            </a>
                        </li>
                        ...
                        <!-- injured Section -->
                        {{-- <li class="nav-item dropdown">
                        <a href="{{ url('/facilities/injured') }}" class="nav-link text-white dropdown-toggle" id="doctorsDropdown" role="button"
                            data-toggle="dropdown" aria-expanded="false">
                        ...
                        <li class="actions">
                            <a href="{{ url('/rooms/create') }}" title="Add New Room" id="Addrooms"
                                class="down">
                                <i class="fa-solid fa-plus"></i></a>
                            <a href="{{ url('/rooms') }}" class="text-white down" id="Trashrooms">
                                <i class="fa-solid fa-door-closed"></i>
                            </a>
                            <a href="{{ url('/rooms/trash') }}" class="down" id="Deleterooms"
                                title="Trash Rooms">
                                <i class="fa-solid fa-trash"></i>
                            </a>
                        </li>
                        ...
                        <li class="actions">
                            <a href="{{ url('/rooms_type/create') }}" title="Add New Room" id="Addroom_types"
                                class="down">
                                <i class="fa-solid fa-plus"></i></a>
                            <a href="{{ url('/rooms_type') }}" class="text-white down" id="Trashroom_types">
                                <i class="fa-solid fa-table-cells"></i>
                            </a>
                        ...
                        <li class="actions">
                            <a href="{{ url('/roomsClass/create') }}" title="Add New Room" id="AddroomsClass"
                                class="down">
                                <i class="fa-solid fa-plus"></i></a>
                            <a href="{{ url('/roomsClass') }}" class="text-white down" id="TrashroomsClass">
                                <i class="fa-solid fa-crown"></i>
                            </a>
                            <a href="{{ url('/roomsClass/trash') }}" class="down" id="DeleteroomsClass"
                                title="Trash Rooms">
                                <i class="fa-solid fa-trash"></i>
                            </a>
                        </li>
                        ...
                        <li class="actions">
                            <a href="{{ url('/appointments/create') }}" title="Add New Visitor" id="Addvisitors"
                                class="down">
                                <i class="fa-solid fa-plus"></i></a>
                            <a href="{{ url('/appointments') }}" class="text-white down" id="Trashvisitors">
                                <i class="fa-regular fa-calendar-check"></i>
                            </a>
                            {{-- <a href="{{ url('/appointments/trash') }}" class="down" id="Deletevisitors"
                            title="Trash Visitors">
                            <i class="fa-solid fa-trash"></i>
                        </a> --}}
                        </li>
                        ...
                        {{-- <li class="nav-item dropdown">
                        <a class="nav-link text-white dropdown-toggle" id="transDropdown" role="button"
                            data-toggle="dropdown" aria-expanded="false">
                            <i class="fa-solid fa-money-bill-transfer"></i>
                        </a>
                    </li>
                    <li class="actions">
                        <a href="{{ url('/transactions/create') }}" title="Add New Transaction" id="Addtrans"
                            class="down">
                            <i class="fa-solid fa-plus"></i></a>
                        <a href="{{ url('/transactions') }}" class="text-white down" id="Trashtrans">
                            <i class="fa-solid fa-money-bill-transfer"></i>
                        </a>
                        <a href="{{ url('/transactions/trash') }}" class="down" id="Deletetrans"
                ...
                {{-- <li class="nav-item dropdown">
                    <a class="nav-link text-white dropdown-toggle" id="chartsDropdown" role="button"
                        data-toggle="dropdown" aria-expanded="false">

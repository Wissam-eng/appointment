                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-actions">
                                        ...
                                        {{-- <a href="{{ url('/review/' . $item->id . '/edit') }}" title="Edit Student"><i
                                                class="fa-regular fa-pen-to-square"></i></a> --}}

                                        <form id="delete-form-{{ $item->id }}" method="POST"
                                            action="{{ route('review.destroy', $item->id) }}" accept-charset="UTF-8"
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title"><i class="fa-regular fa-user"></i> {{ $item->client->name }}</h5>

    ...
    <div class="container-fluid" style="    padding: 0px;">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" style="justify-content: space-between;background-color:white;">
            <div class="icon">
                ...
                <i class="fa-solid fa-dna" style="font-size: 400%;    color: #3061bc;"></i>
            </div>
                ...
                <div class="card-container" style="width:100%">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <img src="{{ $item->analysis_pic ? asset($item->analysis_pic) : asset('storage/images/default_profile.png') }}" alt="Profile Picture" class="card-img">
                            
                            <div class="card-actions">
                                
                                <a href="{{ url('/analysis/' . $item->id . '/edit') }}" title="Edit Analysis"><i class="fa-regular fa-pen-to-square"></i></a>
                
                   

                                <form id="delete-form-{{ $item->id }}" method="POST" action="{{ route('analysis.destroy', $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                    @csrf
                                    @method('DELETE')
                        ...
                        <div class="card-body">
                            <p class="card-text"><i class="fa-solid fa-dna"></i> {{ $item->analysis_name }}</p>
                            <p class="card-text"><i class="fa-solid fa-hashtag"></i>{{ $item->number_of_days }}</p>
                        </div>
                    </div>
                    @endforeach
                </div>

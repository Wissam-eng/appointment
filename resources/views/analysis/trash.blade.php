        ...
        <div class="container" style="margin-top: 2%;">
            <div class="card-body">
                ...
                <div class="card-container">
                    @foreach ($analysis_deleted as $item)
                        <div class="card">
                            <div class="card-header">
                                <div class="card-actions">
                                    <form id="restore-form-{{ $item->id }}" method="POST"
                                        action="{{ route('analysis.restore', $item->id) }}" accept-charset="UTF-8"
                                    ...
                                    <form id="delete-form-{{ $item->id }}" method="POST"
                                        action="{{ route('analysis.delete', $item->id) }}" accept-charset="UTF-8"
                                        style="display:inline">
                                        {{ Method_field('DELETE') }}
                                        {{ csrf_field() }}
                                ...
                                <img src="{{ $item->analysis_pic ? asset($item->analysis_pic) : asset('storage/images/default_profile.png') }}"
